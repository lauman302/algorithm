...
19:24
Запускаешь цикл: цифры кидаешь с стэк, как только попадается символ операции совершаешь операцию между двумя последними цифрами в стэке
19:24
значение сохраняешь в [-2] а последний элемент pop()
'''